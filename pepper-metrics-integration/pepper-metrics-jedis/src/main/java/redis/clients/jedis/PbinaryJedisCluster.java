...
public class PbinaryJedisCluster implements BasicCommands, BinaryJedisClusterCommands,
    ...
    public PbinaryJedisCluster() {
    }

    public PbinaryJedisCluster(Set<HostAndPort> nodes, int timeout) {
        this(nodes, timeout, DEFAULT_MAX_REDIRECTIONS, new GenericObjectPoolConfig());
    }

    public PbinaryJedisCluster(Set<HostAndPort> nodes) {
        this(nodes, DEFAULT_TIMEOUT);
    }

    public PbinaryJedisCluster(Set<HostAndPort> jedisClusterNode, int timeout, int maxAttempts,
    ...
    public PbinaryJedisCluster(Set<HostAndPort> jedisClusterNode, int connectionTimeout,
    ...
    public PbinaryJedisCluster(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxAttempts, String password, GenericObjectPoolConfig poolConfig) {
        this.connectionHandler = new JedisSlotBasedConnectionHandler(jedisClusterNode, poolConfig,
